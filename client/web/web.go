...
type ServerOpts struct {
	...
	// LoginClient indicates that the server should only serve the minimal
...
// It should only be called by LoginServer.ServeHTTP,
// via LoginServer.apiHandler, which protects the handler
// using gorilla csrf.
